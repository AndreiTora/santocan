...
<body>
			...
			<div class="container">
				...
				<nav class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="http://localhost:8080/santocan/animals">NUESTROS
								ANIMALES</a></li>
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<div class="row contenedor">
				<c:forEach items="${animals}" var="animal">
					<div class="col-sm-4 filterElements ${animal.type}">
						<div class="thumbnail">
							...
							<td><a
												href="<c:url value='/edit-animal-${animal.animalId}' />"
												class="btn btn-success custom-width">Editar</a></td>
										</sec:authorize></li>
									<li>&nbsp; <sec:authorize access="hasRole('ADMIN')">
											<td><a
												href="<c:url value='/delete-animal-${animal.animalId}' />"
		...
		<sec:authorize access="hasRole('ADMIN') ">
			<div>
				<a href="<c:url value='animals/new' />"
					class="btn btn-primary btn-sm">Añadir animal nuevo</a>
			</div>
		</sec:authorize>
	</div>

	<script src="static/js/filterAnimals.js"></script>
</body>
</html>