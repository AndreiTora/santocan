				...
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<form:select path="userProfiles" multiple="true" class="form-control input-sm">
							<form:option items="${roles}" itemValue="id" itemLabel="type" value="1">USER</form:option>
							<sec:authorize access="hasRole('ADMIN') or hasRole('DBA')"><form:options items="${roles}" itemValue="id" itemLabel="type" /></sec:authorize>
						</form:select>
						<div class="has-error">
